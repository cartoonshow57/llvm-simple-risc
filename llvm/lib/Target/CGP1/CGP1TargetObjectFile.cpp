...
static cl::opt<unsigned> SSThreshold(
    "cgp1-ssection-threshold", cl::Hidden,
    cl::desc("Small data and bss section threshold size (default=0)"),
    cl::init(0));

void CGP1TargetObjectFile::Initialize(MCContext &Ctx,
...
// section.
bool CGP1TargetObjectFile::isGlobalInSmallSection(
...
// Return true if this global address should be placed into small data/bss
// section.
bool CGP1TargetObjectFile::isGlobalInSmallSection(const GlobalObject *GO,
                                                   const TargetMachine &TM,
...
// kind.
bool CGP1TargetObjectFile::isGlobalInSmallSectionImpl(
    const GlobalObject *GO, const TargetMachine &TM) const {
...
MCSection *CGP1TargetObjectFile::SelectSectionForGlobal(
...
bool CGP1TargetObjectFile::isConstantInSmallSection(const DataLayout &DL,
                                                     const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *CGP1TargetObjectFile::getSectionForConstant(
