...
#ifndef LLVM_LIB_TARGET_CGP1_CGP1CONDCODE_H
#define LLVM_LIB_TARGET_CGP1_CGP1CONDCODE_H
...
inline static StringRef cgp1CondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToCGP1CondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_CGP1_CGP1CONDCODE_H
