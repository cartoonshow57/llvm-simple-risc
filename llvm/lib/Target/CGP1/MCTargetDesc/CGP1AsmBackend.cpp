...
void CGP1AsmBackend::applyFixup(const MCFragment &, const MCFixup &Fixup,
...
MCFixupKindInfo CGP1AsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  static const MCFixupKindInfo Infos[CGP1::NumTargetFixupKinds] = {
      ...
      //   This does not hold true for CGP1_21 and CGP1_21_F which are applied
