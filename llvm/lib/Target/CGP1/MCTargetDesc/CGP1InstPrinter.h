//= CGP1InstPrinter.h - Convert CGP1 MCInst to asm syntax -------*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a CGP1 MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_CGP1_MCTARGETDESC_CGP1INSTPRINTER_H
#define LLVM_LIB_TARGET_CGP1_MCTARGETDESC_CGP1INSTPRINTER_H
...
#endif // LLVM_LIB_TARGET_CGP1_MCTARGETDESC_CGP1INSTPRINTER_H
