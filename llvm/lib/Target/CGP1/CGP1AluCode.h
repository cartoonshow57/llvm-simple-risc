//===-- CGP1AluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_CGP1_CGP1ALUCODE_H
#define LLVM_LIB_TARGET_CGP1_CGP1ALUCODE_H
...
const int CGP1_PRE_OP = 0x40;
const int CGP1_POST_OP = 0x80;

inline static unsigned encodeCGP1AluCode(unsigned AluOp) {
...
inline static const char *cgp1AluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToCGP1AluCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_CGP1_CGP1ALUCODE_H
