//===- CGP1InstrInfo.h - CGP1 Instruction Information ---------*- C++ -*-===//
//
...
class CGP1InstrInfo : public CGP1GenInstrInfo {
  const CGP1RegisterInfo RegisterInfo;
...
public:
  ...
  virtual const CGP1RegisterInfo &getRegisterInfo() const {
    return RegisterInfo;
  }
  ...
  // efficient. E.g., on CGP1 register-register instructions can set the flag
  ...
  //
  // CGP1 can optimize certain select instructions, for example by predicating
...
#endif // LLVM_LIB_TARGET_CGP1_CGP1INSTRINFO_H
